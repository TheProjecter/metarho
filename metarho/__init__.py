...
# Taken from Django Snippets:
# http://www.djangosnippets.org/snippets/690/
#
# I will override a models save method to include generations of slugs.
#
# Pretty straight forward, I don't have to modify anything.  Even to make
# slugs unique for Releases only within a Project I just have to pass
# it a queryset.
...
def user_name(user):
    '''
    Returns a clean string of either the users proper name if either of the name
    fields are filled out or the username if not.
    '''
